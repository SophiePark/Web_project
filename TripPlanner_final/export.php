...
$trav = implode("",$trav);
 ...
 {  
      ...
      {  
           echo '<script>alert("No title, fileName: $userid-$trav")</script>';  
           $resultName = "$userid-$trav";
      }  
      else  
      {  
           $resultName = $_POST["heading"];
      }

       header("Content-type: application/vnd.ms-word");  
       header("Content-Disposition: attachment;Filename=".$resultName.".doc");  
